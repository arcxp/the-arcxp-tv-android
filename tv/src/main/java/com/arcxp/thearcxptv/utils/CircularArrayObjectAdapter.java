 ...
 */
public class CircularArrayObjectAdapter extends ObjectAdapter {
     ...
     */
    public CircularArrayObjectAdapter(PresenterSelector presenterSelector) {
     ...
     */
    public CircularArrayObjectAdapter(Presenter presenter) {
        super(presenter);
    }
     ...
     */
    public CircularArrayObjectAdapter() {
        super();
    }
    ...
    public int firstEl() {
        return Integer.MAX_VALUE % mItems.size(); //(mItems.size() / 2);
    }

    @Override
    public Object get(int index) {
        if (mItems.size() > 0) {
            return mItems.get(index % mItems.size());
        } else return null;
